...
| Customer Service Representative (CSR) | Handles customer interactions, edits orders, initiates RMAs, processes refunds and communicates order status. | Order Management; Returns/RMA; Shipping (view); Analytics (view) |
